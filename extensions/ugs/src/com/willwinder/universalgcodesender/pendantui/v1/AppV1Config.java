...
public class AppV1Config extends ResourceConfig {
    // PCBs local override: getCartesian() recursively returns another Position.
    // Ignore that computed property for HTTP JSON, preserving x/y/z/a/b/c/units.
    @com.fasterxml.jackson.annotation.JsonIgnoreProperties({"cartesian"})
    public abstract static class PositionJson {}

    @jakarta.ws.rs.ext.Provider
    public static class PositionMapper implements jakarta.ws.rs.ext.ContextResolver<com.fasterxml.jackson.databind.ObjectMapper> {
        private final com.fasterxml.jackson.databind.ObjectMapper mapper =
                new com.fasterxml.jackson.databind.ObjectMapper()
                        .addMixIn(com.willwinder.universalgcodesender.model.Position.class, PositionJson.class);
        @Override
